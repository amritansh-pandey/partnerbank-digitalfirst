...
import PayBills from "../../assets/images/paybill-active.svg";
...
const BottomNavigationBill = ({ brand, theme, lang = "en" }) => {
      ...
      <div className="bottom_navigation">
        ...
        <Link to="/paybill" style={{ textDecoration: "none" }}>
          <div className="bottom_navigation_button">
            ...
            <div>
              <span className="bottom_navigation_text_active">Pay bills</span>
            </div>
          </div>
        </Link>
...
export default BottomNavigationBill;