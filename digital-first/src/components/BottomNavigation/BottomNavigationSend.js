...
import SendBlack from "../../assets/images/send-active.svg";
...
const BottomNavigationSend = ({ brand, theme, lang = "en" }) => {
      ...
      <div className="bottom_navigation">
        ...
        <Link to="/send-money" style={{ textDecoration: "none" }}>
          <div className="bottom_navigation_button">
            ...
            <div>
              <span className="bottom_navigation_text_active">Send</span>
            </div>
          </div>
        </Link>
...
export default BottomNavigationSend;