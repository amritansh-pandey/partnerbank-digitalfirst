...
// Define a function to dynamically import images based on the selected brand and theme

function IntroCarousel({ selectedBrand, selectedTheme }) {
  const [currentSlide, setCurrentSlide] = useState(0);

  const carouselData = [
    {
      heading: 'No hanging around, go digital',
      imageName: 'intro1', // Assuming your image files are named intro1.png, intro2.png, etc.
  ...
  // Load the image dynamically based on selectedBrand and selectedTheme
  const currentImage = importImage(selectedBrand, selectedTheme, carouselData[currentSlide].imageName);
    ...
    <div className="intro-carousel">
      ...
      <div className='intro-main-container'>
        ...
        <div className='intro-image-container'>
          <img src={currentImage.default} alt={`Slide ${currentSlide + 1}`} />
        </div>
