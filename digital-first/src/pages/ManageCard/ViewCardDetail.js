...
import DigitalDebitCardBack from '../../assets/images/card-back-side.png'
...
const ViewCardDetail = ({ brand, theme, lang = "en" }) => {
                ...
                <PrimaryBase2>
                    <div className='base_gradient_container2'>
                        ...
                        <div className='debit-card-container'>
                            <div>
                                <img src={DigitalDebitCardBack} alt="Card" className='debit-card-image' />
                            </div>
